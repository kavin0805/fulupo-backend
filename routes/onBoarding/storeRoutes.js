...
import {onBoardauth} from '../../middleware/auth.js';
...
router.get('/stores',onBoardauth, getAllStores);
router.get('/getStores' , onBoardauth , getStoreList); 
router.get('/stores/:id',onBoardauth, getStoreById);
router.get('/stores/category/:categoryId',onBoardauth, getStoresByCategoryId);
router.put('/stores/:id', onBoardauth, updateStore);
router.delete('/stores/:id', onBoardauth, deleteStore);
