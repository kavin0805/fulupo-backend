...
import { addPurchase, getAllPurchases, getFilteredPurchases, getPurchaseById, getPurchasesByDateRange, getPurchasesByPeriod, updatePurchase } from '../../controllers/FulupoStore/purchaseController.js';
...
router.post('/get/Filter', authMasterStoreAdmin , checkStoreVerified , getFilteredPurchases);
